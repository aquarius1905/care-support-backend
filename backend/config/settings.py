...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'django.log'),  # ログファイルのパス
        },
    },
    'loggers': {
        'django': {
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'django_local'),
...
AUTH_USER_MODEL = 'api.BaseUser'  # アプリ名に合わせて変更
